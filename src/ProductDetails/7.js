...
function FuturisticShelvesDetails() {
    return(
        <div>
            <Navigation />
            ...
            <div className='main-container'>
                ...
                <div className='product-container'>
                    <img className='product-image' src={futuristicshelves} alt="" />
                    <div className='product-description'>
                        <h1 className='product-name'>Futuristic Shelves</h1>
                        <h4 className='product-company'>Luxora</h4>
                        <p className='product-price'>$94.99</p>
...
export default FuturisticShelvesDetails