        ...
        <div>
            ...
            <div className='main-container'>
                ...
                <div className='product-container'>
                    <img className='product-image' src={contempsofa} alt="" />
                    <div className='product-description'>
                        <h1 className='product-name'>Contemporary Sofa</h1>
                        <h4 className='product-company'>Comfora</h4>
...
export default ContempSofaDetails