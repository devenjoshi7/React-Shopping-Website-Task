        ...
        <div>
            ...
            <div className='main-container'>
                ...
                <div className='product-container'>
                    <img className='product-image' src={cuttingedgebed} alt="" />
                    <div className='product-description'>
                        <h1 className='product-name'>Cutting-Edge Bed</h1>
                        <h4 className='product-company'>Homestead</h4>
