        ...
        <div>
            ...
            <div className='main-container'>
                ...
                <div className='product-container'>
                    <img className='product-image' src={loungechair} alt="" />
                    <div className='product-description'>
                        <h1 className='product-name'>Lounge Chair</h1>
                        <h4 className='product-company'>Luxora</h4>
                        <p className='product-price'>$259.99</p>
...
export default LoungeChairDetails